...
void Binariza::OpenImg(QImage *img)
{
        QImage image = *img;
        ui.LBview->clear();
...
QImage* Binariza::process(QImage* img)
{
    if (NULL == img)
    {
        return NULL;
...
vector<int> Binariza::Histogram(QImage* img)//直方图分布
{
